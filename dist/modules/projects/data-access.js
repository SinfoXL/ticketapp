...
exports.ProjectsDataAccess = void 0;
const instance_1 = require("../../database/instance");
const where_clause_1 = require("../../helpers/where-clause");
class ProjectsDataAccess {
    constructor() {
        this.getProjects = (...args_1) => __awaiter(this, [...args_1], void 0, function* (filters = {}, pagination = {}) {
            const { page = 1, limit = 10 } = pagination;
            return yield this.db.project.findMany({
        ...
        this.saveProjects = (projects) => __awaiter(this, void 0, void 0, function* () {
            const projectsSaved = yield this.db.project.createManyAndReturn({
                data: projects,
                skipDuplicates: true,
            });
        ...
        this.updateProject = (id, data) => __awaiter(this, void 0, void 0, function* () {
            const projectUpdated = yield this.db.project.update({
                where: { id },
                data,
            });
