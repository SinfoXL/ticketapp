...
exports.TicketStatusDataAccess = void 0;
const instance_1 = require("../../database/instance");
const where_clause_1 = require("../../helpers/where-clause");
class TicketStatusDataAccess {
    constructor() {
        this.getTicketStatuses = (...args_1) => __awaiter(this, [...args_1], void 0, function* (filters = {}, pagination = {}) {
            const { page = 1, limit = 10 } = pagination;
            return yield this.db.ticketStatus.findMany({
...
exports.TicketStatusDataAccess = TicketStatusDataAccess;
