...
exports.TicketCommentDataAccess = void 0;
const instance_1 = require("../../database/instance");
const where_clause_1 = require("../../helpers/where-clause");
class TicketCommentDataAccess {
    constructor() {
        this.getTicketComments = (...args_1) => __awaiter(this, [...args_1], void 0, function* (filters = {}, pagination = {}) {
            const { page = 1, limit = 10 } = pagination;
            return yield this.db.ticketComment.findMany({
...
exports.TicketCommentDataAccess = TicketCommentDataAccess;
